package com.example.weather_test.service;
        ...
        if(weatherString != null)
        {
            ...
            HttpUtil.sendOkHttpRequest(weatherUrl, new Callback() {
                ...
                public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                    ...
                    Weather weather_update = Utility.handleWeatherResponse(responseText);
                    if (weather_update != null && "ok".equals(weather_update.status)) {
